...
export const metadata: Metadata = {
  title: "Vitaliy - Celebrate Pride & Authenticity",  description: "Join Vitaliy's vibrant LGBTQ+ community celebrating pride, authenticity, and connection. Discover inspiring stories, events, and a safe space to be yourself.",  keywords: "pride, LGBTQ+, community, celebration, authenticity, vitaliy",  metadataBase: new URL("https://vitaliy-pride.com"),
  alternates: {
    canonical: "https://vitaliy-pride.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Vitaliy - Celebrate Pride & Authenticity",    description: "Join Vitaliy's vibrant LGBTQ+ community celebrating pride, authenticity, and connection.",    type: "website",    siteName: "Vitaliy",    images: [{
      url: "https://img.b2bpic.net/free-photo/young-people-celebrating-pride-month_23-2149333079.jpg",      alt: "Vitaliy Pride Celebration"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Vitaliy - Celebrate Pride & Authenticity",    description: "Join Vitaliy's vibrant LGBTQ+ community celebrating pride, authenticity, and connection.",    images: ["https://img.b2bpic.net/free-photo/young-people-celebrating-pride-month_23-2149333079.jpg"]
  }
};
